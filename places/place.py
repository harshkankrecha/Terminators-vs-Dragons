from dragons import dragon_king
...
class Place(object):
        ...
        if fighter.is_dragon:
            if self.dragon is None:
                ...
                if fighter.can_contain(self.dragon):
                    if fighter.contained_dragon is None and self.dragon.can_contain(fighter)==False:
                ...
                # END 3.2
                    ...
                    if self.dragon.can_contain(fighter):
                        if self.dragon.contained_dragon is None and fighter.can_contain(self.dragon)==False:
    ...
    def remove_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            ...
            "*** YOUR CODE HERE ***"
            # END 4.3
            if not isinstance(fighter,dragon_king.DragonKing) or not fighter.is_king:
